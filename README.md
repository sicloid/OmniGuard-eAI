...
No managed cloud service is required. Raspberry Pi 5 is a shared integration
and ARM64 validation target with a bounded functional run recorded; laptop
development remains possible. The physical
